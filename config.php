    ...
    try {
        ...
        switch($e->getMessage()) {
            ...
            case 'SUCCESS':
                ...
                PluginData::set('highrise_vm_user', array(
                    'url' => $url,
                    'token' => $token,
                    'password' => $password,
                    'timezone' => $timezone
...
{ // {{{
    PluginData::set('highrise_vm_user', '');
    $results = array(
...
<div class="vbx-applet" style="background-color:white;">
    <div id="highrise_api_access" class="section">
        ...
        <div class="vbx-input-container input" style="margin-bottom:10px;">
            ...
            <input name="highrise_token" class="medium" type="text" value="<?php echo @$highrise_vm_user->token ?>" />
        ...
        <div class="vbx-input-container input" style="margin-bottom:5px;">
            ...
            <input name="highrise_password" class="medium" type="password" value="<?php echo @$highrise_vm_user->password ?>" />
